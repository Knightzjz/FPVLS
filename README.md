...
This is a TensorFlow implementation of the Face Pixelation in Live Video Streaming project of <font color="red"><strong><I>University ML Camp Jeju 2019</font></strong></I>. Some of the code is built on the MTCNN work in [MTCNN-Tensorflow](https://github.com/AITTSMD/MTCNN-Tensorflow) and [MTCNN_face_detection_alignment](https://github.com/kpzhang93/MTCNN_face_detection_alignment).<br>
